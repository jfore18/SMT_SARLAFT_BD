PROMPT CREATE OR REPLACE PACKAGE BODY pk_criterios_cc
CREATE OR REPLACE PACKAGE BODY pk_criterios_cc
IS

   FUNCTION f_acumulado_credito (idCriterio NUMBER, valor NUMBER, tipoId VARCHAR2, acumuladoSIPLA NUMBER) RETURN NUMBER IS

        acumulado SIPLA.acumulado_credito%TYPE;
   BEGIN

       SELECT acumulado_credito
         INTO acumulado
         FROM SIPLA
   ...
   BEGIN
       ...
       IF  Pk_Aplicar_Criterios_Inus.g_transaccion_cc.estado_cuenta != cod_cuenta_activa THEN
		  	  Pk_Aplicar_Criterios_Inus.p_grabar_criterio_tr (
			  				     Pk_Aplicar_Criterios_Inus.g_transaccion.codigo_archivo,
   			 					 Pk_Aplicar_Criterios_Inus.g_transaccion.fecha_proceso,
								 Pk_Aplicar_Criterios_Inus.g_transaccion.id,
   ...
   FUNCTION f_cuenta_reabierta (idCriterio NUMBER) RETURN NUMBER IS
       cuenta_reabierta NUMBER := 1;
   BEGIN

       IF  Pk_Aplicar_Criterios_Inus.g_transaccion_cc.cuenta_reabierta = cuenta_reabierta THEN
		  	  Pk_Aplicar_Criterios_Inus.p_grabar_criterio_tr (
			  				     Pk_Aplicar_Criterios_Inus.g_transaccion.codigo_archivo,
   			 					 Pk_Aplicar_Criterios_Inus.g_transaccion.fecha_proceso,
								 Pk_Aplicar_Criterios_Inus.g_transaccion.id,
   ...
   BEGIN
       dias_diferencia := Pk_Aplicar_Criterios_Inus.g_transaccion.fecha -
           Pk_Aplicar_Criterios_Inus.g_transaccion_cc.fecha_apertura;
   ...
   BEGIN
       ...
       IF  Pk_Aplicar_Criterios_Inus.g_transaccion_cc.signo_sobregiro = signo_sobregiro THEN
		  	  Pk_Aplicar_Criterios_Inus.p_grabar_criterio_tr (
			  				     Pk_Aplicar_Criterios_Inus.g_transaccion.codigo_archivo,
   			 					 Pk_Aplicar_Criterios_Inus.g_transaccion.fecha_proceso,
								 Pk_Aplicar_Criterios_Inus.g_transaccion.id,
   ...
   BEGIN
       IF  Pk_Aplicar_Criterios_Inus.g_transaccion_cc.signo_promedio = signo_promedio THEN
		  	  Pk_Aplicar_Criterios_Inus.p_grabar_criterio_tr (
			  				     Pk_Aplicar_Criterios_Inus.g_transaccion.codigo_archivo,
   			 					 Pk_Aplicar_Criterios_Inus.g_transaccion.fecha_proceso,
								 Pk_Aplicar_Criterios_Inus.g_transaccion.id,
   ...
   BEGIN
       ...
       IF  Pk_Aplicar_Criterios_Inus.g_transaccion.fecha <
           Pk_Aplicar_Criterios_Inus.g_transaccion_cc.fecha_apertura  THEN
		  	  Pk_Aplicar_Criterios_Inus.p_grabar_criterio_tr (
			  				     Pk_Aplicar_Criterios_Inus.g_transaccion.codigo_archivo,
   			 					 Pk_Aplicar_Criterios_Inus.g_transaccion.fecha_proceso,
								 Pk_Aplicar_Criterios_Inus.g_transaccion.id,
   ...
   BEGIN
       ...
       IF (Pk_Aplicar_Criterios_Inus.g_transaccion_cc.promedio_semestral > 0) --ADD CPB 10JUN2004
           AND (Pk_Aplicar_Criterios_Inus.g_transaccion.valor_transaccion >
                (nVecesPromedio * Pk_Aplicar_Criterios_Inus.g_transaccion_cc.promedio_semestral))
       THEN
		  	  Pk_Aplicar_Criterios_Inus.p_grabar_criterio_tr (
			  				     Pk_Aplicar_Criterios_Inus.g_transaccion.codigo_archivo,
   			 					 Pk_Aplicar_Criterios_Inus.g_transaccion.fecha_proceso,
   ...
   BEGIN
       ...
       IF (Pk_Aplicar_Criterios_Inus.g_transaccion_cc.saldo > 0) --ADD CPB 10JUN2004
           AND (Pk_Aplicar_Criterios_Inus.g_transaccion.valor_transaccion >
                (nVecesSaldo * Pk_Aplicar_Criterios_Inus.g_transaccion_cc.saldo))
       THEN
		  	  Pk_Aplicar_Criterios_Inus.p_grabar_criterio_tr (
			  				     Pk_Aplicar_Criterios_Inus.g_transaccion.codigo_archivo,
   			 					 Pk_Aplicar_Criterios_Inus.g_transaccion.fecha_proceso,
   ...
   BEGIN
       ...
       IF (Pk_Aplicar_Criterios_Inus.g_transaccion_cc.promedio_semestral > 0) --ADD CPB 23JUN2004
           AND (Pk_Aplicar_Criterios_Inus.g_transaccion.valor_transaccion >
                 (nVecesPromedio * Pk_Aplicar_Criterios_Inus.g_transaccion_cc.promedio_semestral)
		       AND Pk_Lib.f_valor_en_lista_multiple
